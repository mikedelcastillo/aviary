...
export function DeleteToast({ name, onUndo, onDismiss }: DeleteToastProps) {
  return (
    <div className="fixed bottom-safe left-4 z-40 flex items-center gap-3 rounded-2xl border border-border bg-surface/90 px-3.5 py-2.5 text-sm shadow-lg backdrop-blur-md">
